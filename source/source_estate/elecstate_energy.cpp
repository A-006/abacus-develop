...
#ifdef __MPI
    Parallel_Reduce::reduce_max_double(GlobalV::NPROC, vbm_up);
    Parallel_Reduce::reduce_min_double(GlobalV::NPROC, cbm_up);
    Parallel_Reduce::reduce_max_double(GlobalV::NPROC, vbm_dw);
    Parallel_Reduce::reduce_min_double(GlobalV::NPROC, cbm_dw);
#endif
